...
public class LinearTask {
	...
	public static void task08() {
		// 08. Вычислить значение выражения по формуле (все переменные принимают действительные значения)
		double a = 2;
		double b = 3;
		double c = 4;
		double rez;
	...
	public static void task09() {
		// 09. Вычислить значение выражения по формуле (все переменные принимают действительные значения)
		double a = 2;
		double b = 3;
		double c = 4;
		double d = 5;
	...
	public static void task30() {
		// 30. Три сопротивления R 1 R 2 , и R 3 соединены параллельно. Найдите сопротивление соединения
		double R1 = 10;
		double R2 = 12;
		double R3 = 14;
		double RR;
